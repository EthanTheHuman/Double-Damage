...
public:
	...
	void Render()
	{
		...
		//printf("mesh size: %d \n", meshes.size());
			...
			this->meshes[i].model = translation * rotation * scale;
	...
	{
		translation = glm::translate(glm::mat4(), _Translation);
	};
	...
	{
		glm::vec3 NewScale = { _Scale.x, _Scale.y, _Scale.z };
		scale = glm::scale(glm::mat4(), NewScale);
	};
